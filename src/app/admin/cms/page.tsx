  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Administrador de Banners e Interacciones (CMS)</h1>
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200 space-y-6 shadow-sm max-w-3xl">
        <h3 className="text-lg font-bold text-slate-900 flex items-center gap-2">
          <ImageIcon className="w-5 h-5 text-amber-600" /> Editar Carrusel Principal (Hero Section)
        </h3>
        ...
        <form onSubmit={handleSaveCMS} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl bg-slate-50 border border-slate-200 p-4 text-xs font-bold text-slate-900 focus:outline-none focus:border-amber-500"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-2xl bg-slate-50 border border-slate-200 p-4 text-xs font-bold text-amber-700 focus:outline-none focus:border-amber-500"
            />
          </div>
