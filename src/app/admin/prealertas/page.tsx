...
export default function AdminPrealertasPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-200">
      <div>
        <h1 className="text-3xl font-black text-white tracking-tight">Gestión y Vinculación Manual de Prealertas</h1>
      ...
      <div className="bg-slate-900 rounded-3xl border border-slate-800 overflow-hidden shadow-xl space-y-4 p-6">
        <h3 className="text-base font-bold text-white">Prealertas Pendientes por Vinculación Manual</h3>
                ...
                <tr key={item.id} className="hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="py-4 px-4">
                    <input
                      ...
                      className="w-32 px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800 text-xs font-mono font-bold text-white focus:outline-none focus:border-amber-400"
                    />
                  </td>
